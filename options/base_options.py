...
class BaseOptions():
    ...
    def initialize(self, parser):
        # base define
        parser.add_argument('--name', type=str, default='pl2', help='name of the experiment.')
        parser.add_argument('--model', type=str, default='ctn', help='name of the model type. [ctn]')
        parser.add_argument('--mask_type', type=int, default=[2,4],
                            help='mask type, 0: center mask, 1:random regular mask, '
                            '2: random irregular mask (PIC). 3: external irregular mask. 4: other irregular mask (GC). [0],[1,2],[1,2,3], [2,4]')
        ...
        parser.add_argument('--img_file', type=str, default='D:\\data\\p2temp', help='training and testing dataset')
        parser.add_argument('--mask_file', type=str, default='D:\\data\\irregular_mask\\3', help='load test mask')
